...
3. Go to Signature section, select where you want to display either post/page or both and select the desired size for your signature image.
4. You can optionally add text (i.e. Best Regards) before User name and signature.
...
2. Signature below post
3. Signature in user profile
