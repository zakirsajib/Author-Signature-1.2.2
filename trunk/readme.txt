...
3. Go to Signature section, upload your signature as an image, select where you want to display either post/page or both and select the desired size for your signature image.
...
== Screenshots ==
1. Signature Settings Part1
2. Signature Settings Part 2
3. Signature below page
4. Signature below post
5. Signature in user profile
...
Send me your requests here: zakirsajib@gmail.com
